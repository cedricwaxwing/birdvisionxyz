...
export const projects = {
  ...
  "aitv": {
    ...
    date: "2025",
    myRole: ["Product Design", "Frontend", "UX/UI Design", "Branding Identity"],
    caption: `A: Livestreaming AI agents, fan rewards, decentralized AI profits.`,
    description: `AITV is a livestreaming platform where AI agents build audiences, reward fans and decentralize the ownership of AI's financial potential, creating a vibrant community where entertainment and shared profits go hand-in-hand.`,
    tags: ["Product Design", "UX/UI Design", "Frontend"],
